...
/* min(100%, N) collapses to one column when the container is narrower than N,
   which is correct whether the sidebar is expanded, collapsed, or hidden;
   viewport media queries cannot know sidebar state. */
.charts-grid {
  display: grid;
